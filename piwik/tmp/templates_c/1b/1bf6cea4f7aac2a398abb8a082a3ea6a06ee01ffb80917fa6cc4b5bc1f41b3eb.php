        ...
        <div>";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["entry"]) {
                ...
                if (((twig_length_filter($this->env, $this->getAttribute($context["entry"], "devices", array())) == 1) && twig_in_filter(call_user_func_array($this->env->getFilter('translate')->getCallable(), array("General_Unknown")), $this->getAttribute($this->getAttribute($this->getAttribute($context["entry"], "devices", array()), 0, array(), "array"), "name", array())))) {
                    // line 9
                    echo "                        <span>";
                    echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("DevicesDetection_XVisitsFromDevices", (("<strong>" . $this->getAttribute($context["entry"], "count", array())) . "</strong>"), (("<strong>" . $this->getAttribute($context["entry"], "type", array())) . "</strong>")));
                    echo "
                    ";
                } else {
                    // line 11
...
{% endif %}", "@DevicesDetection/_profileSummary.twig", "/var/www/html/piwik/plugins/DevicesDetection/templates/_profileSummary.twig");
    }
}
